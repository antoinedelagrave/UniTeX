...
\begin{frame}[fragile]
    \frametitle{Personnalisation - En-têtes, pieds de page et sections}
    Avec \textcolor{vibrant_green}{\textit{fancyhdr}}\footnotemark, on modifie les en-têtes et pieds de page grâce à l'utilisation d'un nouveau style de page~:
    \vfill
...
\begin{frame}[fragile]
    ...
    Par exemple~:
    \vfill
    \begin{lstlisting}[xleftmargin=-1.75cm, basicstyle=\small]
        \fancyhead[L,C]{}
...
\begin{frame}
    \frametitle{Personnalisation - En-têtes, pieds de page et sections}
    Le module \textcolor{vibrant_green}{\textit{titlesec}}\footnotemark permet de choisir le format des titres de sections, sous-sections, etc.
    \begin{columns}
