...
\subsection{Mathématiques avancées}
...
\begin{frame}
    ...
    Le module \textcolor{vibrant_green}{\textit{physics}}\footnotemark est de loin un des outils les plus utiles.
    \pause
    \vspace{0.3cm}
    \begin{itemize}
        \item[$\diamond$] Gestion de parenthèses $()$, crochets $[]$ et accolades $\{\}$.
        \item[$\diamond$] Notation vectorielle.
        \item[$\diamond$] Opérateurs mathématiques ($\sin, \det, \Trace,\dots$).
        \item[$\diamond$] Notation différentielle.
        \item[$\diamond$] Raccourcis pour la notation matricielle.
...
\begin{frame}
  \frametitle{Physique et mathématiques - Mathématiques avancées}
  L'essentiel pour la notation mathématique peut être résumé par les modules~:
  \vspace{0.3cm}
  \pause
    \begin{itemize}
